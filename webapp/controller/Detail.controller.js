...
sap.ui.define([
	...
	"crud/model/formatter",
	"sap/m/MessageBox",
	"sap/m/MessageToast",
	"sap/ui/commons/TreeNode"
], function(BaseController, JSONModel, formatter, MessageBox, MessageToast, TreeNode) {
	"use strict";
	...
	return BaseController.extend("crud.controller.Detail", {
		...
		onDelete: function() {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/Matnr"),
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getModel().metadataLoaded().then(function() {
				var sObjectPath = this.getModel().createKey("MaraSet", oParameter);
