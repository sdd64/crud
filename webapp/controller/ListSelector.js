sap.ui.define([
	...
	return BaseObject.extend("crud.model.ListSelector", {
		 ...
		 * @return {crud.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
