sap.ui.define([
	"crud/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/m/MessageBox",
	'sap/ui/model/type/String',
	'sap/ui/model/ValidateException'
], function(BaseController, JSONModel, MessageBox, StringType, ValidateException) {
	"use strict";

	return BaseController.extend("crud.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("MaraSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("MaraSet", oData);
		...
		onStaffNumberChange: function(oEvent){
		    ...
		    if (this._isValidStuffNumber(sStaffNumber)) {
		        ...
		        oSource.setValueState("Error").
		          setValueStateText("'" + sStaffNumber + "' ist keine valide Personalnummer (AB-12345-C)");
		    }
		...
		typeStaffNumber: StringType.extend("stuffNumber", {
