sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("crud/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("crud.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["crud/localService/mockserver"], function(mockserver) {
