sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Matnr").length, 1, "The sorting by Matnr returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Matnr and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Matnr");
